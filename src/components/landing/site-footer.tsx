          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6 flex gap-3">
              <a
                ...
                className="group flex h-11 w-11 items-center justify-center rounded-full border border-gold-300 bg-cream-50 text-gold-700 transition-all hover:border-gold-500 hover:bg-gold-500 hover:text-cream-50"
              >
